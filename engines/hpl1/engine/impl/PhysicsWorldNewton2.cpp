...
#include "hpl1/engine/impl/PhysicsWorldNewton2.h"

#include "hpl1/engine/impl/CharacterBodyNewton2.h"
#include "hpl1/engine/impl/CollideShapeNewton2.h"
#include "hpl1/engine/impl/PhysicsBodyNewton2.h"
#include "hpl1/engine/impl/PhysicsMaterialNewton2.h"

#include "hpl1/engine/impl/PhysicsJointBallNewton2.h"
#include "hpl1/engine/impl/PhysicsJointHingeNewton2.h"
#include "hpl1/engine/impl/PhysicsJointScrewNewton2.h"
#include "hpl1/engine/impl/PhysicsJointSliderNewton2.h"

#include "hpl1/engine/impl/PhysicsControllerNewton2.h"
...
static void* newtonMalloc(int sz) {
	return malloc(sz);
}

static void newtonFree(void* ptr, int sz) {
	free(ptr);
}

cPhysicsWorldNewton::cPhysicsWorldNewton()
	: iPhysicsWorld() {
	mpNewtonWorld = NewtonCreate(newtonMalloc, newtonFree);
